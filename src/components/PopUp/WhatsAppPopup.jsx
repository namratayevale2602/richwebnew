...
function WhatsAppPopup() {
  ...
  const branches = [
    {
      name: "RICH System Solutions Pvt. Ltd.",
      address:
        "401, 4th Floor, Akravi Disha, Opposite Hotel City Pride, Tilakwadi, Nashik, Maharashtra ,India",
              ...
              {branches.map((branch, index) => (
                <div key={index} className="mb-4 last:mb-0">
                  ...
                  <div className="grid grid-cols-2 gap-2 ml-6">
                    {/* WhatsApp Button */}
                    <a
                      href={`https://wa.me/${branch.whatsapp}?text=Hello%20Dr.%20I%20would%20like%20to%20know%20more%20about%20your%20services`}
                      target="_blank"
